...
function Score:drawImage()
	...
	playdate.graphics.pushContext(img)
		...
		-- playdate.graphics.drawRoundRect(0, 0, self.width, self.height, 4)
		-- Text
		...
		playdate.graphics.drawTextInRect("" .. self.value, 8, 24, self.width - 16, self.height, nil, nil, kTextAlignment.left)
